		...
		<header className={s.header}>
			...
			<nav className={cn(s.navbar, openMenu && s.menu)}>
				<ul className={s.links}>
					<li className={s.link}>
						<NavLink to="/React-Star-Wars/" onClick={handleNavLinkClick}>
							Home
						</NavLink>
					</li>
					<li className={s.link}>
						<NavLink to="React-Star-Wars/people?page=1" onClick={handleNavLinkClick}>
							Characters
						</NavLink>
					</li>
					<li className={s.link}>
						<NavLink to="React-Star-Wars/search" onClick={handleNavLinkClick}>
							Search
						</NavLink>
					</li>
				</ul>
